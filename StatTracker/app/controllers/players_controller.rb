   ...
   @pitching_stats_post=PitchingPostStat.find(:all, :conditions => ['player_id = ?', params[:id]])
    ...
    @pitching_stats_post.each { |b|
      ...
      @chart4.set_cell(i, 3, b.team.division.league.name.to_s)
			@chart4.set_cell(i, 4, b.wins.to_s)
      @chart4.set_cell(i, 5, b.losses.to_s)
      @chart4.set_cell(i, 6, b.win_loss_percentage.to_s )
      @chart4.set_cell(i, 7, b.era.to_s )
      @chart4.set_cell(i, 8, b.games.to_s )
      @chart4.set_cell(i, 9, b.games_started.to_s )
      @chart4.set_cell(i, 10, b.games_finished.to_s )
      @chart4.set_cell(i, 11, b.complete_games.to_s )
      @chart4.set_cell(i, 12, b.shutouts.to_s)
      @chart4.set_cell(i, 13, b.saves.to_s )
      @chart4.set_cell(i, 14, b.innings_pitched.to_s )
      @chart4.set_cell(i, 15, b.hits.to_s )
      @chart4.set_cell(i, 16, b.runs.to_s )
      @chart4.set_cell(i, 17, b.earned_runs.to_s)
      @chart4.set_cell(i, 18, b.home_runs.to_s)
      @chart4.set_cell(i, 19, b.walks.to_s)
      @chart4.set_cell(i, 20, b.intentional_walks.to_s )
      @chart4.set_cell(i, 21, b.strikeouts.to_s)
      @chart4.set_cell(i, 22, b.hit_by_pitch.to_s )
      @chart4.set_cell(i, 23, b.balks.to_s )
      @chart4.set_cell(i, 24, b.wild_pitches.to_s)
      @chart4.set_cell(i, 25, b.batters_faced.to_s )
      @chart4.set_cell(i, 26, b.walks_and_hits_innings_pitched.to_s )
      @chart4.set_cell(i, 27, b.hits_innings.to_s )
      @chart4.set_cell(i, 28, b.home_runs_innings.to_s )
      @chart4.set_cell(i, 29, b.walks_innings.to_s )
      @chart4.set_cell(i, 30, b.strikeouts_innings.to_s )
      @chart4.set_cell(i, 31, b.strikeouts_walks.to_s )
		}
  options = { :width => 900, :allowHtml=>true }
  options.each_pair do | key, value |
