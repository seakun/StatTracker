...
#		 @chart.set_cell(i, 3, numbergames, "<span title=#{totalgames}>#{numbergames}</span>")
...
#		   @chart.set_cell(i, 6, numberruns, "<span title=#{totalruns}>#{numberruns}</span>")
#		   @chart.set_cell(i, 7, @player.career_hits, "<span title=#{totalhits}>#{@player.career_hits}</span>")
#		 @chart.set_cell(i, 8, numberdoubles, "<span title=#{totaldoubles}>#{numberdoubles}</span>")
#		 @chart.set_cell(i, 9, numbertriples, "<span title=#{totaltriples}>#{numbertriples}</span>")
#		 @chart.set_cell(i, 10, @player.career_home_runs, "<span title=#{totalhome}>#{@player.career_home_runs}</span>")
#		 @chart.set_cell(i, 11, numberrbi, "<span title=#{totalrbi}>#{numberrbi}</span>")
#		 @chart.set_cell(i, 12, @player.career_stolen_bases, "<span title=#{totalstolen}>#{@player.career_stolen_bases}</span>")
#		 @chart.set_cell(i, 13, @player.career_caught_stealing, "<span title=#{totalcaught}>#{@player.career_caught_stealing}</span>")
#		 @chart.set_cell(i, 14, @player.career_walks, "<span title=#{totalwalks}>#{@player.career_walks}</span>")
#		 @chart.set_cell(i, 15, @player.career_strikeouts, "<span title=#{totalstrikes}>#{@player.career_strikeouts}</span>")
...
#		 @chart.set_cell(i, 18,  @player.career_total_bases, "<span title=#{bases}>#{@player.career_total_bases}</span>")
...
#		 @chart.set_cell(i, 21,  "<span title='Isolated Power'>#{@player.career_isolated_power}</span>")
   ...
   @batting_stats_post=BattingPostStat.find(:all, :conditions => ['player_id = ?', params[:id]])
    ...
    @chart2.set_cell(i, 13, b.stolen_bases, "<span title=#{stolen}>#{b.stolen_bases.to_s}</span>")
    @chart2.set_cell(i, 14, b.caught_stealing, "<span title=#{caught}>#{b.caught_stealing.to_s}</span>")
    @chart2.set_cell(i, 15, b.walks, "<span title=#{walks}>#{b.walks.to_s}</span>")
    @chart2.set_cell(i, 16, b.strikeouts, "<span title=#{strikes}>#{b.strikeouts.to_s}</span>")
    ...
    @chart2.set_cell(i, 19, b.total_bases, "<span title=#{bases}>#{b.total_bases.to_s}</span>")
...
#     @chart2.set_cell(i, 4, numbergames, "<span title=#{totalgames}>#{numbergames}</span>")
...
#		 @chart2.set_cell(i, 7, numberruns, "<span title=#{totalruns}>#{numberruns}</span>")
#		 @chart2.set_cell(i, 8, @player.career_hits_post, "<span title=#{totalhits}>#{@player.career_hits_post}</span>")
#		 @chart2.set_cell(i, 9, numberdoubles, "<span title=#{totaldoubles}>#{numberdoubles}</span>")
#		 @chart2.set_cell(i, 10, numbertriples, "<span title=#{totaltriples}>#{numbertriples}</span>")
#		 @chart2.set_cell(i, 11, @player.career_home_runs_post, "<span title=#{totalhome}>#{@player.career_home_runs_post}</span>")
#		 @chart2.set_cell(i, 12, numberrbi, "<span title=#{totalrbi}>#{numberrbi}</span>")
#		 @chart2.set_cell(i, 13, @player.career_stolen_bases_post, "<span title=#{totalstolen}>#{@player.career_stolen_bases_post}</span>")
#		 @chart2.set_cell(i, 14, @player.career_caught_stealing_post, "<span title=#{totalcaught}>#{@player.career_caught_stealing_post}</span>")
#		 @chart2.set_cell(i, 15, @player.career_walks_post, "<span title=#{totalwalks}>#{@player.career_walks_post}</span>")
#		 @chart2.set_cell(i, 16, @player.career_strikeouts_post, "<span title=#{totalstrikes}>#{@player.career_strikeouts_post}</span>")
...
#		 @chart2.set_cell(i, 19,  @player.career_total_bases_post, "<span title=#{bases}>#{@player.career_total_bases_post}</span>")
...
#		 @chart2.set_cell(i, 22,  "<span title='Isolated Power'>#{@player.career_post_isolated_power}</span>")
  options = { :width => '100%', :allowHtml =>true }
  options.each_pair do | key, value |
...
#     @chart3.set_cell(i, 7, numbergames, "<span title=#{totalgames}>#{numbergames}</span>")
#     @chart3.set_cell(i, 8, numberstarted, "<span title=#{totalstarted}>#{numberstarted}</span>")
#     @chart3.set_cell(i, 9, "<span title=#{totalfinished}>#{numberfinished}</span>")
#     @chart3.set_cell(i, 10, numbercomplete, "<span title=#{totalcomplete}>#{numbercomplete}</span>")
#     @chart3.set_cell(i, 11, numbershutouts, "<span title=#{totalshutouts}>#{numbershutouts}</span>")
#     @chart3.set_cell(i, 12, numbersaves, "<span title=#{totalsaves}>#{numbersaves}</span>")
...
#     @chart3.set_cell(i, 19, numberintentional, "<span title=#{totalintentional}>#{numberintentional}</span>")
...
#     @chart3.set_cell(i, 22, numberbalks, "<span title=#{totalbalks}>#{numberbalks}</span>")
#     @chart3.set_cell(i, 23, numberwild, "<span title=#{totalwild}>#{numberwild}</span>")
...
#     @chart4.set_cell(i, 8, numbergames, "<span title=#{totalgames}>#{numbergames}</span>")
#     @chart4.set_cell(i, 9, numberstarted, "<span title=#{totalstarted}>#{numberstarted}</span>")
#     @chart4.set_cell(i, 10, "<span title=#{totalfinished}>#{numberfinished}</span>")
#     @chart4.set_cell(i, 11, numbercomplete, "<span title=#{totalcomplete}>#{numbercomplete}</span>")
#     @chart4.set_cell(i, 12, numbershutouts, "<span title=#{totalshutouts}>#{numbershutouts}</span>")
#     @chart4.set_cell(i, 13, numbersaves, "<span title=#{totalsaves}>#{numbersaves}</span>")
...
#     @chart4.set_cell(i, 20, numberintentional, "<span title=#{totalintentional}>#{numberintentional}</span>")
...
#     @chart4.set_cell(i, 23, numberbalks, "<span title=#{totalbalks}>#{numberbalks}</span>")
#     @chart4.set_cell(i, 24, numberwild, "<span title=#{totalwild}>#{numberwild}</span>")
